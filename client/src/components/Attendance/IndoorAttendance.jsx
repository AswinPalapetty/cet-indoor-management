...
function IndoorAttendance() {
  ...
  useEffect(()=>{
    axios.get('/staff/fetchIndoorAttendance').then((result) =>{
  ...
  const markAttendance = () => {
    ...
    axios.post('/staff/markIndoorAttendance', studentData).then((result) => {
    ...
    <div>
      ...
      <div className="container-fluid">
        ...
        <div className="row justify-content-center">
          <h2 className="text-center attendance-title"><span className="first-letter">I</span>NDOOR <span className="first-letter">A</span>TTENDANCE</h2>
...
export default IndoorAttendance